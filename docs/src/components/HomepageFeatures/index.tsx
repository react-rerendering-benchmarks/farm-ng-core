...
const FeatureList: FeatureItem[] = [
  {
    ...
    description: (
      <>
        Foundational core layer for new c++ and python projects. Convenient
        macros such as FARM_ENUM, FARM_ASSERT_* and FARM_UNWRAP. Component
        pipeline for easy parallelization of data processing pipelines.
  ...
  },
  {
    ...
    description: (
      <>
        ...
        kannala-brandt and orthographic), IMU mode and more. Python bindings are
        available for a subset of the library.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        ...
        Buffer-based datasets and some more general purpose c++/python
        utilities.
      </>
    ),
  },
